    ...
    <div className="flex items-center justify-center min-h-screen bg-[#707070] px-4">
      <div className="bg-white p-6 rounded-2xl shadow-lg w-full max-w-lg">
       ...
       <div className="flexCenter my-4">
          ...
          <div className="flex justify-between gap-2 sm:gap-3">
            {otp.map((digit, idx) => (
              <input
                ...
                pattern="[0-9]*"
                maxLength={1}
                className="w-10 h-12 sm:w-12 sm:h-14 border border-[#959595] rounded-lg text-center text-lg font-medium focus:outline-Secondary"
        ...
        disabled={loading || !otp.every((e) => e.trim() !== "")}>
